...
**Vendor guide:** [OpenAI — Sora 2 prompting guide](https://developers.openai.com/cookbook/examples/sora/sora2_prompting_guide)
...
`productId`, `prompt`, `aspectRatio`, `duration` — see reference.md.
